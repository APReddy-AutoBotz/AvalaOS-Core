...
import { User, Task, Project, Sprint, Filters, WidgetType, WidgetDefinition, WidgetConfigs, WidgetConfig, AiProviderType } from '../types';
...
const CustomDashboardView: React.FC<CustomDashboardViewProps> = (props) => {
    ...
    const renderWidget = (widgetId: WidgetType) => {
        ...
        return (
            <div key={widgetId} style={{ gridArea: definition.gridArea }}>
