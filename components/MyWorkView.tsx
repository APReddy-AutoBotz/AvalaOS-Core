...
const MyWorkView: React.FC<MyWorkViewProps> = ({ view, allTasks, allProjects, allEpics, currentUser, onUpdateTaskStatus, onUpdateTask, onSelectTask, onAddTask, onDeleteTask, quickFilter, setQuickFilter }) => {
    ...
    const renderView = () => {
        ...
        switch(view) {
            ...
            case View.BOARDS:
                return <BoardsView tasks={filteredTasks} projects={visibleProjects} epics={visibleEpics} onUpdateTaskStatus={onUpdateTaskStatus} onSelectTask={onSelectTask} onAddTask={onAddTask} onDeleteTask={onDeleteTask} showProjectLabel={true} />;
            case View.GANTT:
