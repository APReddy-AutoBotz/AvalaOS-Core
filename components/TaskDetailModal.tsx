...
import { Task, Project, Epic, User, TaskStatus, TaskPriority, UserStory, AcceptanceCriterion, Attachment } from '../types';
...
// Main Component
// ===================================
const TaskDetailModal: React.FC<TaskDetailModalProps> = ({ task, allTasks, project, epic, users, onClose, onUpdateTask, onAddTask, onDeleteTask }) => {
...
const getFileIcon = (fileType: string) => {
    ...
    if (fileType.includes('Word')) return <DocumentTextIcon className="w-5 h-5 text-blue-500" />;
