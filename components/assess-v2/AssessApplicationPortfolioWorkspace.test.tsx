...
const projection:any={inventory:[],metadataVersions:[],importReceipts:[],processLinks:[],dependencies:[],dimensions:[],recommendations:[],reviews:[],portfolioSnapshot:null,waves:[],economicsReferences:[],rowOutcomes:[],assessments:[{id:'draft-id',applicationId:'app-id',orgId:'org',workspaceId:'workspace',metadataVersion:2,version:1,status:'draft',authorId:'author',decisionModelVersion:'model',dimensions:[],recommendations:[]},{id:'reviewer-ready-id',applicationId:'app-id',orgId:'org',workspaceId:'workspace',metadataVersion:2,version:2,status:'reviewer_ready',authorId:'author',decisionModelVersion:'model',dimensions:[],recommendations:[]}]};
