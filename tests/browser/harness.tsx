...
const Harness = () => {
  ...
  return <main>
    ...
    <p data-testid="title-sink" dangerouslySetInnerHTML={{ __html: escapePlainText('<img src=x onerror=alert(1)>safe title') }} />`n    <section aria-labelledby="svg-heading"><h2 id="svg-heading">Diagram sink</h2><div data-testid="svg-sink" dangerouslySetInnerHTML={{ __html: sanitizeMermaidSvg(svgAttack) }} /></section>
