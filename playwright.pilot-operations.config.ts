...
export default defineConfig({
  ...
  webServer:{command:'npx vite --host 127.0.0.1 --port 4427 --strictPort',url:'http://127.0.0.1:4427/tests/browser/pilotOperationsHarness.html',reuseExistingServer:!process.env.CI,timeout:120_000,env:{...process.env,VITE_AVALA_RUNTIME_MODE:'automated_test',VITE_AI_EDGE_FUNCTIONS_ENABLED:'false'}},
});
