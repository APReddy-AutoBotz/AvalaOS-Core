...
export const ADMIN_WORKBENCH_SECTIONS: readonly AdminSectionDefinition[] = [
  {
    ...
    label: 'Overview',
    shortLabel: 'Overview',
    description: 'Review organization context, module access, proof posture, evidence/approval/audit/export/artifact storage/RLS and hosted/deployment/operations preparation contract summaries, and next admin decisions.',
