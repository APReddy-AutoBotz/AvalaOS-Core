...
const assignment: ReviewAssignment = { ...binding, id: 'assignment-1', reviewVersion: ASSESS_V2_REVIEW_VERSION, authorActorId: 'author', reviewerActorId: 'reviewer', reviewerAuthorizationVersion: 7, assignedBy: 'lead', assignedAt: '2026-07-20T10:00:00.000Z', requestId: 'request-a', receiptId: 'receipt-a', auditId: 'audit-a' };
const evidence = [
...
const resolution = (status: ReviewResolution['status']): ReviewResolution => ({ ...binding, id: `resolution-${status}`, assignmentId: assignment.id, reviewVersion: ASSESS_V2_REVIEW_VERSION, status, reviewerActorId: 'reviewer', reviewerAuthorizationVersion: 7, rationale: 'Review checkpoints completed.', conditions: [], confidence: 'Insufficient Evidence', resolvedAt: '2026-07-20T12:00:00.000Z', requestId: 'request-resolution', receiptId: 'receipt-resolution', auditId: 'audit-resolution' });
...
const run = () => {
  ...
  const govern: GovernResolution = { ...binding, id: 'govern-1', reviewResolutionId: approved.id, reviewVersion: approved.reviewVersion, resolverActorId: 'governor', rationale: 'Preserved deterministic action boundaries.', actions: deterministic, requiredControls: ['Human Approval'], rollbackRequirements: ['compensate'], monitoringRequirements: ['audit'], reviewFrequency: 'quarterly', accountableOwner: 'finance-owner', resolvedAt: '2026-07-20T14:00:00.000Z' };
