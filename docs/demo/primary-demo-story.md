...
4. Avala Govern records owner, autonomy, risk, allowed actions, blocked actions, approval, evidence, and audit status.
...
7. Avala Delivery shows source lineage, approval/evidence checklists, blockers, work items, and Delivery Pack review output.
...
- Start from deterministic assessment and evidence, then show Avala Govern before any handoff.
...
The demo proves governed delivery: evaluate first, govern next, then hand off with evidence.
