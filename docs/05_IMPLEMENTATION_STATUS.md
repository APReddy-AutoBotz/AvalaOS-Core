...
PR #214 is merged at `4fd672981b397207d46c8c9ccfe038e98012fe4e`, with corrective acceptance still pending for four unresolved authority/concurrency findings. The corrective candidate separates detailed and snapshot read capabilities, derives Process × Application Govern/economics ancestry from committed PR 1D/1E/1F records, scopes assessment progression and lifecycle actions to an explicitly selected application, and serializes workspace snapshot versions. Post-merge verification and tag closure remain blocked until the corrective PR is merged and verified. No deployment or hosted/live validation is claimed.
