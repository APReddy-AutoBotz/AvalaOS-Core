...
PR 1E Govern resolution is action-specific and bound to the exact approved V2 review. Deterministic prohibitions cannot be removed, approval-bound actions cannot become autonomous, and high-impact financial, external-communication, or irreversible actions require a resolver independent of both author and final reviewer. The result is a control-plane record only.
