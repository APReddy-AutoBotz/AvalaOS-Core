...
6. run all 336 retained and due-actionability scenarios, including superseded/revoked starvation, contradictory metadata, runtime pauses, hold/retention pause and resume, discovery-to-claim invalidation, deterministic mixed-kind ordering, response non-disclosure, mutation/audit/provider zero deltas, and two-worker fencing;
