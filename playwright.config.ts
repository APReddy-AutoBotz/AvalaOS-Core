...
export default defineConfig({
  ...
  testIgnore: ['pr1d.spec.ts', 'pr1e.spec.ts', 'studioArtifacts.spec.ts', 'studioPrivateArtifacts.spec.ts', 'enterpriseIntelligence.spec.ts', 'pilotOperations.spec.ts', 'hostedPilot.spec.ts', 'hostedAccessibilityPerformance.spec.ts', 'exhaustiveHostedAcceptance.spec.ts'],
  forbidOnly: true,
