...
const governedRpcDomainSignals = new Set([
  ...
  'ENTERPRISE_ASSESS_DOCUMENT_MAPPING_COMMIT_STALE',
  'ENTERPRISE_ASSESS_DOCUMENT_MAPPING_CONFLICT_STALE',
  'ENTERPRISE_ASSESS_DOCUMENT_MAPPING_FAILURE_INVALID',
  'ENTERPRISE_ASSESS_DOCUMENT_MAPPING_FEATURE_DISABLED',
  'ENTERPRISE_ASSESS_DOCUMENT_MAPPING_IMMUTABLE',
  'ENTERPRISE_ASSESS_DOCUMENT_MAPPING_INVALID',
  'ENTERPRISE_ASSESS_DOCUMENT_MAPPING_NATIVE_SHAPE_INVALID',
  'ENTERPRISE_ASSESS_DOCUMENT_MAPPING_PREVIEW_STALE',
  'ENTERPRISE_ASSESS_DOCUMENT_MAPPING_PROPOSAL_INVALID',
  'ENTERPRISE_ASSESS_DOCUMENT_MAPPING_PROVIDER_INPUT_TOO_LARGE',
  'ENTERPRISE_ASSESS_DOCUMENT_MAPPING_REVIEW_INVALID',
  'ENTERPRISE_ASSESS_DOCUMENT_MAPPING_REVIEW_STALE',
  'ENTERPRISE_ASSESS_DOCUMENT_MAPPING_SOURCE_STALE',
  'ENTERPRISE_ASSESS_DOCUMENT_MAPPING_STAGE_INVALID',
  'ENTERPRISE_ASSESS_DOCUMENT_MAPPING_STALE',
  'ENTERPRISE_ASSESS_DOCUMENT_MAPPING_TARGET_INVALID',
