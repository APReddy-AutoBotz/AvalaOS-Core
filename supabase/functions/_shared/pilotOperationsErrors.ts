const codes = [
  ...
  'EVIDENCE_NOT_VERIFIED','PREFLIGHT_BLOCKED','PROVIDER_REFERENCE_STALE','PROVIDER_REFERENCE_INVALID',
...
export const pilotOperationsFailureStatus = (code: PilotOperationsGovernedCode) =>
  ...
  ['FEATURE_DISABLED','ENVIRONMENT_BLOCKED','MAINTENANCE_ACTIVE','READ_ONLY_ACTIVE','MAINTENANCE_MODE','READ_ONLY_MODE','PREFLIGHT_BLOCKED'].includes(code) ? 423 :
