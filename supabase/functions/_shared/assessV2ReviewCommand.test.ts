...
const envelope={requestId:'77777777-7777-4777-8777-777777777777',idempotencyKey:'attest-current-1',commandType:'assessment_v2.evidence.attest',organizationId:org,workspaceId:workspace,authorizationVersion:7,expectedVersion:4,payload:{caseId,decisionId,reviewSequence:1,evidenceId,claimIds:['primitive.invoice.volume'],outcome:'accepted',rationale:'Source and claim independently checked.'}} as const;
...
const main=async()=>{
 ...
 const base={...envelope,payload:{caseId,decisionId,reviewSequence:1}};
 const variants=[
  ...
  {...base,commandType:'assessment_v2.govern.resolve',payload:{...base.payload,rationale:'controls reviewed',controlDispositions:[{controlId:'audit',status:'resolved',condition:'',owner:'',dueDate:'',conditionSatisfied:false}]}},
 ...
 for(const invalid of [
   ...
   {...envelope,payload:{...envelope.payload,reviewSequence:0}},
