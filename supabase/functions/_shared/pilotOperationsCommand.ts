...
const OPS = new Set<PilotOperation>(['register_environment','register_release_candidate','validate_release_candidate','approve_promotion','simulate_promotion','supersede_release_candidate','bind_provider_reference','bootstrap_tenant','deprovision_tenant','reactivate_tenant','set_runtime_control','record_recovery_drill']);
const REQUIRED: Record<PilotOperation, string> = {
  ...
  approve_promotion:'release.approve', simulate_promotion:'release.promote', supersede_release_candidate:'release.manage',
