...
import { assessV2ApplicationPortfolioDependencies } from '../_shared/assessV2ApplicationPortfolioDb.ts';

declare const Deno:{serve:(handler:(request:Request)=>Response|Promise<Response>)=>void};
Deno.serve(async request=>handleOptions(request)??handleAssessV2Request(request,assessV2Dependencies,assessV2ReviewDependencies,assessV2EconomicsDependencies,assessV2ApplicationPortfolioDependencies));
