...
import { SYNTHETIC_CHAIN_START_NAME, SYNTHETIC_CHAIN_START_VERSION, SYNTHETIC_MIGRATION_NAME, SYNTHETIC_MIGRATION_VERSION, SYNTHETIC_PRIOR_VERSION, classifySyntheticMigrationChain, classifySyntheticMigrationState } from './prCSyntheticAcceptanceMigration.mjs';
