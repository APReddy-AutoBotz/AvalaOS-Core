...
try {
  ...
  assert.equal(approvedFullChainTip(migrations), '20260923144653');
  ...
  assert.equal(renewalIndex, migrations.length - 6);
  ...
  const assertFinalIdentity = async (db, expectedTip = '20260923144653') => {
