...
try {
  ...
  assert.equal(approvedFullChainTip(migrations), '20260923190853');
  ...
  assert.equal(renewalIndex, migrations.length - 8);
  ...
  const assertFinalIdentity = async (db, expectedTip = '20260923190853') => {
