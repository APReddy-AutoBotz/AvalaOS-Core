...
try {
  ...
  assert.equal(approvedFullChainTip(migrations), '20260923142120');
  ...
  assert.equal(renewalIndex, migrations.length - 5);
  ...
  const assertFinalIdentity = async (db, expectedTip = '20260923142120') => {
