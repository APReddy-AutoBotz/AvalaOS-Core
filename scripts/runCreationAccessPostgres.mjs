...
try {
  ...
  assert.equal(approvedFullChainTip(migrations), '20260923151115');
  ...
  assert.equal(renewalIndex, migrations.length - 7);
  ...
  const assertFinalIdentity = async (db, expectedTip = '20260923151115') => {
