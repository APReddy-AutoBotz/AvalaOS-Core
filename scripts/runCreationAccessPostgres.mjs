...
try {
  ...
  assert.equal(approvedFullChainTip(migrations), '20260926053818');
  ...
  assert.equal(migrations[renewalIndex + 3], '20260923133000_pr1e_evidence_claim_operator_binding.sql');
  assert.equal(migrations[renewalIndex + 4], '20260923142120_pr1e_govern_control_alias_binding.sql');
  assert.equal(migrations[renewalIndex + 5], '20260923144653_studio_command_authority_capabilities.sql');
  ...
  assert.equal(renewalIndex, migrations.length - 11);
  ...
  const assertFinalIdentity = async (db, expectedTip = '20260926053818') => {
