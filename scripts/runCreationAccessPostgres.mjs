...
try {
  ...
  assert.equal(approvedFullChainTip(migrations), '20260923133000');
  ...
  assert.equal(renewalIndex, migrations.length - 4);
  ...
  const assertFinalIdentity = async (db, expectedTip = '20260923133000') => {
