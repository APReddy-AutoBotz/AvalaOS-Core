...
const GIT_FAILURE_OPERATIONS = new Set(['add','checkout','clone','commit','commit-tree','config','diff','for-each-ref','fsck','init','ls-files','ls-tree','merge-base','pack-objects','remote','rev-list','rev-parse','status','update-ref','write-tree']);
const GIT_FAILURE_REASONS = new Set(['ARGV','INPUT_LIMIT','OUTPUT_LIMIT','TIMEOUT','EXECUTION','SIGNAL','STATUS']);
