...
try{
 ...
 check((await one(client,`SELECT migration_tip FROM public.hosted_pilot_environment_identity WHERE singleton`)).migration_tip,baselineUpgrade?'20260917173445':'20260924052038');
