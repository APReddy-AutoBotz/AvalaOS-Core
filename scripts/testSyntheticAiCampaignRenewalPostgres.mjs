...
assert.equal(migrations.at(-5),predecessor);
assert.equal(migrations.at(-3),'20260923062439_studio_server_helper_permissions.sql');
assert.equal(migrations.at(-2),'20260923082000_studio_frd_section_id_contract.sql');
