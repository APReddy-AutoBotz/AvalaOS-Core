...
assert.equal(migrations.at(-12),predecessor);
assert.equal(migrations.at(-10),'20260923062439_studio_server_helper_permissions.sql');
assert.equal(migrations.at(-9),'20260923082000_studio_frd_section_id_contract.sql');
assert.equal(migrations.at(-8),'20260923133000_pr1e_evidence_claim_operator_binding.sql');
assert.equal(migrations.at(-7),'20260923142120_pr1e_govern_control_alias_binding.sql');
assert.equal(migrations.at(-6),'20260923144653_studio_command_authority_capabilities.sql');
assert.equal(migrations.at(-5),'20260923151115_studio_handoff_receipt_binding.sql');
