...
assert.equal(migrations.at(-6),predecessor);
assert.equal(migrations.at(-4),'20260923062439_studio_server_helper_permissions.sql');
assert.equal(migrations.at(-3),'20260923082000_studio_frd_section_id_contract.sql');
assert.equal(migrations.at(-2),'20260923133000_pr1e_evidence_claim_operator_binding.sql');
assert.equal(migrations.at(-1),'20260923142120_pr1e_govern_control_alias_binding.sql');
